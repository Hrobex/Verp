...
// ======================= التغيير الجذري هنا =======================
// نستخدم module.exports بدلاً من 'export default' لتعريف الدالة
// هذا يحل التعارض مع نظام الوحدات في مشروعك بشكل نهائي
    ...
    try {
        ...
        for (const modelName of MODEL_FALLBACK_CHAIN) {
            try {
                ...
                // fetch متاحة بشكل عام في بيئة Vercel ولا تحتاج لـ require
