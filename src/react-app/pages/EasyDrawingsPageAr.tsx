...
const faqData = [
  {
    ...
    answer: (
      <>
        كلا الأداتين تقدم نتائج رائعة! هذه الأداة مصممة لإنشاء <strong>اسكتش فني</strong> غني بالتفاصيل والظلال يحاكي الرسم اليدوي، مما يعطي إحساسًا بالعمق الفني. بينما أداة <Link to="/ar/line-drawing" className="text-yellow-400 hover:underline">تحويل الصور إلى رسم رصاص</Link> متخصصة في استخراج <strong>الخطوط الواضحة والنقية</strong> من صورتك، وهي مثالية لصفحات التلوين أو التصميمات التي تتطلب خطوطًا محددة.
      </>
    )
  },
  {
