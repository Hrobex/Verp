...
import { Link } from 'react-router-dom'; // تم الاستيراد لإضافة الرابط في الأسئلة الشائعة
                  ...
                  <div className="space-y-6">
                      {faqData.map((faq, index) => (
                          <div key={index} className="bg-gray-800 p-6 rounded-lg">
                              ...
                              <p className="text-gray-300 leading-relaxed">{typeof faq.answer === 'string' ? faq.answer : faq.answer}</p>
                          </div>
                      ))}
                  </div>
              </section>
...
export default LineArtifyPageArabic;    e.stopPropagation();
    e.currentTarget.classList.add('border-blue-500');
  };
