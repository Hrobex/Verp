...
// هذا مكون مساعد لمنطقة السحب والإفلات.
...
// بيانات الأسئلة الشائعة لأداة LineArtify
const faqData = [
    {
      question: 'ما الفرق بين LineArtify وأداة تحويل الصور إلى اسكتش؟',
      answer: 'تركز LineArtify على إنشاء خطوط نظيفة ومميزة، شبيهة بالرسم التخطيطي أو الكفافي. بينما تقوم أداة تحويل الصور إلى اسكتش غالبًا بإعادة إنتاج التظليل والملمس وتأثير القلم الرصاص المرسوم يدويًا. LineArtify مثالية لإنشاء مخططات تفصيلية أو صفحات تلوين أو فن بسيط.'
    },
    {
      question: "ما الفرق بين نمط \"بسيط\" و \"معقد\"؟",
      answer: 'النمط "البسيط" (V1) يولد خطوطًا نظيفة وبسيطة، وهو مثالي للحصول على تأثير رسم خطي أساسي. أما النمط "المعقد" (V2) فيلتقط المزيد من التفاصيل من صورتك الأصلية، مما ينتج عنه رسم خطي أكثر ثراءً وتعقيدًا.'
    },
    {
      question: 'هل أداة إنشاء الرسم الخطي هذه مجانية حقًا؟',
      answer: 'نعم، 100%. أداة LineArtify مجانية تمامًا للاستخدام بدون أي قيود على عدد التحويلات. يمكنك تحويل أي عدد من الصور إلى رسومات خطية حسب حاجتك، دون أي تكلفة أو تسجيل دخول.'
    },
    {
      question: 'ما هي أنواع الصور التي تعطي أفضل النتائج؟',
      answer: 'للحصول على أفضل نتيجة لتحويل الصور إلى رسم خطي، استخدم صورًا ذات مواضيع واضحة وإضاءة جيدة وتباين عالٍ. الصور ذات الحواف المحددة جيدًا تميل إلى إنتاج رسومات خطية أكثر نظافة ودقة.'
    },
    {
      question: 'هل يمكنني استخدام الرسم الخطي الناتج في مشاريع تجارية؟',
      answer: 'نعم. يمكنك استخدام الرسومات الخطية التي تنشئها في المشاريع الشخصية والتجارية على حد سواء. ومع ذلك، تقع على عاتقك مسؤولية التأكد من امتلاكك لحقوق الصورة الأصلية التي تقوم بتحويلها.'
    },
];
...
function LineArtifyPageArabic() {
  ...
  const handleDownloadClick = () => {
    ...
    a.href = resultImage;
    a.download = `rasm-khati_${sourceFile?.name.split('.')[0] || 'image'}.png`;
        ...
        {`
          {
            ...
            "name": "LineArtify: أداة تحويل الصور إلى رسم خطي بالذكاء الاصطناعي",
            "operatingSystem": "WEB",
        ...
        <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl sm:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600">
              LineArtify: تحويل الصور إلى رسم خطي بالذكاء الاصطناعي
            </h1>
            <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto">
              ارفع صورتك وشاهد الذكاء الاصطناعي يحولها إلى رسم خطي نقي ومذهل، فورًا ومجانًا.
            </p>
          </div>
          <div className="bg-gray-800/50 p-6 sm:p-8 rounded-2xl shadow-lg">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              />
              <div className="w-full flex flex-col items-center">
                <h3 className="text-lg font-semibold text-gray-300 mb-4">الرسم الخطي الناتج</h3>
                <div className="w-full h-64 bg-gray-800 rounded-lg flex items-center justify-center p-4 border-2 border-dashed border-gray-600">
                  {isLoading && (
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <p className="text-gray-400">جاري التحويل إلى رسم خطي...</p>
                    </div>
                  )}
                  {!isLoading && !resultImage && (
                    <p className="text-center text-gray-500">سيظهر الرسم الخطي الخاص بك هنا</p>
                  )}
                  {resultImage && !isLoading && (
                    <img src={resultImage} alt="الرسم الخطي الناتج" className="max-w-full max-h-full object-contain rounded-md" />
                  )}
                </div>
              </div>
            </div>
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              >
                {isLoading ? 'جاري التحويل...' : 'حوّل إلى رسم خطي'}
              </button>
              {resultImage && !isLoading && (
                 <button
          ...
          <div className="mt-24">
              <section className="text-center">
                  <h2 className="text-3xl font-bold mb-4">الطريقة الأذكى لإنشاء رسومات خطية</h2>
                  <p className="max-w-3xl mx-auto text-gray-400 mb-12">تقدم LineArtify أداة مجانية لا مثيل لها عبر الإنترنت للفنانين والمصممين والهواة لتحويل أي صورة إلى رسم خطي نقي.</p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                      <div className="bg-gray-800 p-6 rounded-lg shadow-md"><h3 className="text-xl font-bold text-cyan-400 mb-2">فوري ومجاني</h3><p className="text-gray-300">حوّل صورًا غير محدودة إلى رسومات خطية عبر الإنترنت. بدون رسوم، بدون تسجيل، فقط قوة إبداعية خالصة.</p></div>
                      ...
                      <div className="bg-gray-800 p-6 rounded-lg shadow-md"><h3 className="text-xl font-bold text-cyan-400 mb-2">بسيط للجميع</h3><p className="text-gray-300">لا حاجة لبرامج أو مهارات. الواجهة السهلة تجعل تحويل الصور إلى رسم خطي مهمة لا تتطلب أي مجهود.</p></div>
              ...
              <section className="mt-20 text-center">
                   <h2 className="text-3xl font-bold mb-4">حوّل أي صورة لرسم خطي في ثوانٍ</h2>
                   <p className="max-w-3xl mx-auto text-gray-400 mb-12">تم تصميم عمليتنا لتعطيك رسمًا خطيًا مثاليًا بأقل جهد ممكن.</p>
                   <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                       <div className="bg-gray-800/50 p-6 rounded-lg">
                        ...
                        <div className="bg-gray-800/50 p-6 rounded-lg">
                          ...
                          <p className="text-gray-300">اختر النمط المفضل لديك — "بسيط" للخطوط النظيفة أو "معقد" لمزيد من التفاصيل — ثم انقر على زر "حوّل إلى رسم خطي".</p>
                       </div>
                        <div className="bg-gray-800/50 p-6 rounded-lg">
                          <p className="text-cyan-400 font-bold text-lg mb-2">الخطوة 3: حمّل واستخدم</p>
                          <p className="text-gray-300">سيظهر رسمك الخطي الجديد في لحظات. قم بتنزيله بجودة عالية واستخدمه في أي مشروع يمكنك تخيله.</p>
                       </div>
                   </div>
              </section>
              <section className="mt-20 max-w-4xl mx-auto">
                  <h2 className="text-3xl font-bold text-center mb-10">أسئلة شائعة حول أداة تحويل الصور إلى رسم خطي</h2>
