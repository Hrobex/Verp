    ...
    },
    {
        ...
        answer: (
            <>
                ...
                بينما أداة <Link to="/ar/image-to-sketch" className="text-cyan-400 hover:underline">ArtifyPro</Link> مصممة لإنشاء <strong>اسكتش فني</strong> متكامل يحاكي الرسم اليدوي، مع تظليل غني وتفاصيل دقيقة لإعطاء انطباع فني أعمق وأكثر واقعية.
            </>
        )
    },
    {
