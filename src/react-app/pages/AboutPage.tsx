          ...
          <div className="space-y-16 text-lg leading-relaxed">
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <p>
                  Driven by this idea, <strong>we launched AIConvert in 2023</strong> with a simple, yet powerful belief: the power of AI creativity should be accessible to everyone, without barriers. We set out to build a platform that wasn't just a collection of tools, but a public utility for creators, thinkers, and anyone with an idea.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <blockquote className="border-r-4 border-amber-500 bg-gray-800/50 p-6 rounded-r-lg italic">
                Our mission is to <strong>democratize creativity</strong> by providing a comprehensive suite of high-quality AI tools, <strong>completely free, for everyone, forever.</strong>
              </blockquote>
            </section>
