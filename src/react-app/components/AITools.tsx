...
const tools = [
  ...
  },
  {
    ...
    alt: 'A before-and-after image showing ArtifyPro converting a portrait photo into a detailed artistic sketch.'
  },
  {
    id: 'line-drawing',
    title: 'LineArtify: Photo to Line Drawing',
        description: 'Transform your photos into elegant, clean line art, perfect for outlines and coloring pages.',
    icon: Pencil,
    color: 'from-cyan-500 to-blue-600',
    features: ['Instant conversion', 'Clean Outlines', 'Simple & Complex Styles'],
