...
const tools = [
  ...
  {
    id: 'remove-background', // تم التصحيح
  ...
  {
    id: 'image-enhancement', // مثال لم نغيره بعد
          ...
          {tools.map((tool) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                {/* --- تم تبسيط الرابط هنا ليكون أقوى --- */}
