...
import PromptigenPageArabic from "@/react-app/pages/PromptigenPageArabic"; // <-- 1. تم استيراد المكون العربي الجديد
      ...
      <Routes>
        ...
        <Route element={<App />}>
          ...
          <Route path="ar">
            ...
            <Route path="prompt-generator" element={<PromptigenPageArabic />} /> {/* <-- 2. تم إضافة المسار العربي الجديد هنا */}
          </Route>
